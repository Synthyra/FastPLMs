"""Load official DPLM model from the official/transformers submodule for comparison.
...
def load_official_model(
    ...
    """Load the official DPLM model (ESM2 architecture) from the transformers submodule.
