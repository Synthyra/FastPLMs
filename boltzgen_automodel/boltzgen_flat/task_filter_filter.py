...
from boltzgen_flat.task_analyze_analyze_utils import compute_liability_scores
from boltzgen_flat.task_filter_seqplot_utils import (
    aa_composition_pie,
    cdr_logo,
...
class Filter(Task):
    ...
    **Diversity.** A lazy-greedy selection chooses `div_budget` designs maximizing:
    ...
    Examples
    --------
    >>> from boltzgen_flat.task_filter_filter import Filter
    >>> filter = Filter(
