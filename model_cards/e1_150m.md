...
This checkpoint contains the FastPLMs `E1` implementation.
...
backend raises. It does not silently change implementation.
...
- FastPLMs weights: `Synthyra/Profluent-E1-150M`
