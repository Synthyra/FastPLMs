...
`Synthyra/Profluent-E1-150M` packages the `Profluent-Bio/E1-150m` checkpoint
...
python -m pip install -r \
  "https://huggingface.co/Synthyra/Profluent-E1-150M/resolve/main/requirements.txt"
```
...
`dist/hub/Profluent-E1-150M` path. Pass `local_files_only=True`.
...
- FastPLMs checkpoint: `Synthyra/Profluent-E1-150M`
- Runtime revision: recorded separately in the built artifact and published commit
- Runtime source identities: recorded in `source-record.json`
- Official checkpoint: `Profluent-Bio/E1-150m`
