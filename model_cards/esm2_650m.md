...
`Synthyra/ESM2-650M` packages the `facebook/esm2_t33_650M_UR50D` checkpoint
...
`dist/hub/ESM2-650M` path. Pass `local_files_only=True`.
...
- FastPLMs checkpoint: `Synthyra/ESM2-650M`
