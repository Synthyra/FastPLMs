...
`dist/hub/ANKH_large` path, then pass `local_files_only=True`.
...
The live `Synthyra/ANKH_large` revision `3be3df34140f49dc4e65bd1f247e3ce819e7fc59` is legacy
...
The current manifest Hub revision `3be3df34140f49dc4e65bd1f247e3ce819e7fc59` for
`Synthyra/ANKH_large` is legacy encoder-only. It supports the `AutoModel`
...
- FastPLMs weights: `Synthyra/ANKH_large@3be3df34140f49dc4e65bd1f247e3ce819e7fc59`
