...
`Synthyra/ESM2-35M` packages the `facebook/esm2_t12_35M_UR50D` checkpoint with
...
python -m pip install -r \
  "https://huggingface.co/Synthyra/ESM2-35M/resolve/main/requirements.txt"
```
...
`dist/hub/ESM2-35M` path. Pass `local_files_only=True`.
...
- FastPLMs checkpoint: `Synthyra/ESM2-35M`
- Runtime revision: recorded separately in the built artifact and published commit
- Runtime source identities: recorded in `source-record.json`
- Official checkpoint: `facebook/esm2_t12_35M_UR50D`
