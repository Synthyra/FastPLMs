...
`Synthyra/ESMplusplus_6B` packages the `biohub/ESMC-6B` checkpoint with the
...
sae = AutoModel.from_pretrained("biohub/ESMC-6B-sae-layer60-k64-codebook16384", device=model.device)
...
- FastPLMs checkpoint: `Synthyra/ESMplusplus_6B`
