...
`Synthyra/Profluent-E1-300M` packages the `Profluent-Bio/E1-300m` checkpoint
...
python -m pip install -r \
  "https://huggingface.co/Synthyra/Profluent-E1-300M/resolve/main/requirements.txt"
```
...
`dist/hub/Profluent-E1-300M` path. Pass `local_files_only=True`.
...
- FastPLMs checkpoint: `Synthyra/Profluent-E1-300M`
- Runtime revision: recorded separately in the built artifact and published commit
- Runtime source identities: recorded in `source-record.json`
- Official checkpoint: `Profluent-Bio/E1-300m`
