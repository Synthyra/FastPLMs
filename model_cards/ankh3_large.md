...
python -m pip install -r \
  "https://huggingface.co/Synthyra/ANKH3_large/resolve/main/requirements.txt"
```
...
`dist/hub/ANKH3_large` path. Pass `local_files_only=True`.
...
- FastPLMs checkpoint: `Synthyra/ANKH3_large`
