...
`Synthyra/DPLM2-650M` packages the `airkingbd/dplm2_650m` checkpoint with the
...
`dist/hub/DPLM2-650M` path. Pass `local_files_only=True`.
...
- FastPLMs checkpoint: `Synthyra/DPLM2-650M`
