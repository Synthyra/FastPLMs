...
from fastplms.dplm.modeling_dplm import DPLMConfig as FastDPLMConfig, DPLMForMaskedLM
...
if __name__ == "__main__":
    # py -m fastplms.dplm.get_weights
    import argparse
    ...
    for repo_id, source_repo in _resolve_repo_items(args.repo_ids):
        ...
        api.upload_file(
            path_or_fileobj=os.path.join(os.path.dirname(os.path.abspath(__file__)), "modeling_dplm.py"),
